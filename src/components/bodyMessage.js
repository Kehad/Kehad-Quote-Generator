...
const BodyMessage = () => {
  ...
  //   console.log(rnd);
  //   if (rnd.length === 2) {
  //     const rndToNine = Math.round(Math.random() * 9).toString();
  //     const result = rnd.concat(rndToNine);
  //     console.log(rndToNine, result);
  //     setNumColor(result);
  //   } else if (rnd.length === 1) {
  //     const rndToNine = Math.round(Math.random() * 9).toString();
  //     const rndToNineSec = Math.round(Math.random() * 9).toString();
  //     const result = rnd.concat(rndToNine, rndToNineSec);
  //     console.log(rndToNine, result);
  //     setNumColor(result);
  //   } else {
  //     // setNumColor(rnd);
  ...
  // };
  // colorGenerator();
  // useEffect to fetch a random quote on component mount
